...
// map data from API calls to divs and render page
  render() {
    return (
/* form for enering city and price level and divs for each set of API data
   Weather, Restaurant, Hotels and Night Clubs */
    <Container>
      <Row>
